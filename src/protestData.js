export default [
  {
    ...
    protestColor: '#EE343D',
    event:
      'An online petition is currently circulating which is calling on Google to pay its fair share of taxes, following news that company has utilized foreign shell companies to shelter more than $33 Billion USD of revenue. Of which, $2 Billion USD worth of taxes is owed around the world.',
    date: 'Ongoing',
    year: 'Ongoing',
    theme: 'Tax Evasion',
    protest: 'Tax Evasion',
  ...
  },
  {
    ...
    protestColor: '#EE343D',
    event:
      'Coordinated efforts by Uber and Lyft drivers are made by switching off app to create an artificial surge in demand for drivers, and subsequently increase their fare. This tactic has been used into response to drivers struggling to make a living-wage due the companies inherently flawed business model.',
    date: 'Ongoing',
    year: 'Ongoing',
    theme: 'Labor / Wage',
    protest: 'Labor/Wage',
  ...
  },
  {
    ...
    protestColor: '#263692',
    event:
      'Over 1.7 million people sign an online petition demanding HP, ABP, Veolia, Barclays, Caterpillar and G4S.',
    date: 'Ongoing',
    year: 'Ongoing',
  ...
  },
  {
    ...
    protestColor: '#263692',
    event:
      "Approximately 70 people protested near Palantir Technologies' cafeteria to garner the attention of Palantir employees, so they might also take a stand against the company's sale of software to ICE.",
    date: '08/17/2019',
    year: '2019',
    theme: 'Ethics (ICE)',
    protest: 'Ethics',
  ...
  },
  {
    ...
    protestColor: '#263692',
    event:
      "Hundreds of demonstrators gathered in New York inside and outside an Amazon Books, protesting the company's involvement with ICE. 44 people were reported to have been arrested.",
    date: '08/11/2019',
    year: '2019',
    theme: 'Ethics (ICE)',
    protest: 'Ethics',
  ...
  },
  {
    ...
    protestColor: '#263692',
    event:
      "In response to Amazon's announcement that they wished to located on of their 2 new headquarters in New York, Protestors gathered outside of a public hearings for the project at New York City Council",
    date: '12/28/2018',
    year: '2018',
    theme: 'Ethics',
    protest: 'Ethics',
  ...
  },
  {
    ...
    protestColor: '#27AB4F',
    event:
      'Organizers of the November 2018 Google walk-out demand an end to forced arbitration. Following the walk-out, Google only allowed arbitration for sexual harassment and assault cases for full-time employees and not contract workers. Feeling the response to be insufficient, organizers of the previous walk-out drafted letter demanding an end to arbitration for all employees and all forms of labor disputes. The letter also called for the support of other employees working in the tech industry.',
    date: '12/10/2018',
    year: '2018',
    theme: 'Forced Arbitration',
    protest: 'Forced Arbitration',
  ...
  },
  {
    ...
    protestColor: '#263692',
    event:
      "In response to Amazon's announcement that they wished to located on of their 2 new headquarters in New York, Protestors gathered in Court House Square, (Queens, New York).",
    date: '11/26/2018',
    year: '2018',
    theme: 'Ethics',
    protest: 'Ethics',
  ...
  },
  {
    ...
    protestColor: '#263692',
    event:
      'An open letter written by IBM employees and addressed to CEO Ginni Rometty, demanded the company reaffirm its values and acknowledge the right of employees refuse participation in US government contracts which violate civil liberties.',
    date: '02/12/2017',
    year: '2017',
    theme: '',
    protest: 'Other',
  ...
  },
  {
    ...
    country: 'Internet',
    source: [
      'https://www.business-humanrights.org/en/apple-criticised-by-gay-rights-activists-after-approving-"gay-cure"-application-for-iphone-ipad',
    ],
  },
  {
    id: 88,
