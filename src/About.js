  ...
  return (
    <div className="Homeblock">
      <Container>
        ...
        <Row className="justify-content-md-center">
          <Col xs>
            <h3 className="titlecase Description">About Glass Room</h3>
          </Col>
        </Row>
        <Row className="justify-content-md-center">
          <Col xs>
...
visitors in the past two years.</p>
        ...
        <Row className="justify-content-md-center">
          <Col xs>
            <h3 className="titlecase Description">About Tactical Tech</h3>
          </Col>
        </Row>
...
worked to demystify the impact of technology by creating high-quality, accessible resources and engaging cultural spaces.</p>
        ...
        <Row className="justify-content-md-center">
          <Col xs>
            <h3 className="titlecase Description">About TechEquity Collaborative</h3>
          </Col>
        </Row>
        <Row className="mb-3 Description">
          <Col xs>
